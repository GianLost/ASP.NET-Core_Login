...
public static class FieldsValidation
{
    ...
    public static string GetConfirmationErrorClass(this IHtmlHelper htmlHelper)
    {
        ...
        bool passwordsMismatch =
            !string.IsNullOrEmpty(htmlHelper.ViewData.ModelState["Password"]?.AttemptedValue)
            && !string.IsNullOrEmpty(htmlHelper.ViewData.ModelState["confirmPass"]?.AttemptedValue)
            && htmlHelper.ViewData.ModelState["Password"]?.AttemptedValue
                != htmlHelper.ViewData.ModelState["confirmPass"]?.AttemptedValue;
